...
namespace UnityEngine.UI.Extensions
{
    ...
    [AddComponentMenu("UI/Extensions/My Scrollrect Conflict Manager")]
    public class MyScrollConflictManager : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        public MyScrollRect ParentScrollRect;
		//public ScrollSnap ParentScrollSnap;
        private MyScrollRect _myScrollRect;
        ...
        void Start()
        {
            ...
            _myScrollRect = this.GetComponent<MyScrollRect>();
