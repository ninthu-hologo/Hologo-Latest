...
namespace Hologo2
{
    ...
    /// Modified by: //Shariz 12th April 2020 v2.0.5
    ...
    /// </summary>
    public class localizationListViewController : MonoBehaviour
    {
        ...
        public void setLocalizationViewActive(int id = -1) //Shariz 12th April 2020 v2.0.5
        {
            countryId = id;
        ...
        {
            Debug.Log(settings.country.id);
            Debug.Log(countryId);

            //Shariz 12th April 2020 v2.0.5
            if (countryId < 0)
            {
                localizeUI.getlocalizeUI().LanguageAndSubmit(false);
            }

            //if (settings.country.id >= 0)
            //{
            //    countryId = localizationList.getCountryListPosition(settings.country.id + 1); //Shariz 12th April 2020 v2.0.5
            //}
        ...
        public void onCountrySelected()
        {
            ...
            else if (countryId == 0)
            {
                ...
                languageId = 0;
                populateLanguagesDropDown();
                localizeUI.getlocalizeUI().LanguageAndSubmit(true);
            }
            else
            {
                localizeUI.getlocalizeUI().LanguageAndSubmit(true);
