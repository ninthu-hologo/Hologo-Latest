...
public  class SaveToWave
{
    ...
    public bool Save(string filename, AudioClip clip)
    {
        ...
        var filepath = filename; //Path.Combine(Application.persistentDataPath, filename);
       // var filepath = Path.Combine(Application.dataPath + "/Resources/VoiceRecord", filename);
